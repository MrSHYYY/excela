...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    // Every collection that holds this user's data: sessions, pending linking tokens, conversations, then the user record itself
    ...
    await (await telegramConversationsCollection()).deleteMany({ userId: user._id });
